                    ...
                    <div className="col-md-5 p-4">
                        <div class= {style.card} >
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text text-muted">Pierre Hillard est un spécialiste du "mondialisme".</p>
                                <div className="d-grid gap-2">
                                    ...
                                    <div className="d-grid gap-2">
                                    <a href="https://x.com/PierreHillard?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" class="btn btn-outline-primary">Pour accéder au site sur<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-twitter-x mx-2" viewBox="0 0 16 16">
